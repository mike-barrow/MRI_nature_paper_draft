...
%% TCIA DICOM release (AutoPET-shaped): DICOM hierarchy + a per-examination   %%
...
The dataset is deposited in The Cancer Imaging Archive (TCIA) under accession [TBD -> TCIA] with the Digital Object Identifier [TBD -> TCIA], and is released under a Creative Commons Attribution 4.0 International (CC BY 4.0) license.
...
The imaging follows the standard TCIA DICOM hierarchy.
